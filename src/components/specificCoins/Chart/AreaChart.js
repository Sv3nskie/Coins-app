...
const AreaChart = () => {
  const data = [
    { time: '2018-08-26', value: 54.9 },
    { time: '2018-09-27', value: 54.98 },
    { time: '2018-10-28', value: 57.21 },
    { time: '2018-10-29', value: 57.42 },
    { time: '2018-10-30', value: 56.43 },
    { time: '2018-11-01', value: 55.51 },
    { time: '2018-11-02', value: 56.48 },
    { time: '2018-11-03', value: 58.18 },
    { time: '2018-11-04', value: 57.09 },
    { time: '2018-11-05', value: 56.05 },
    { time: '2018-11-06', value: 56.63 },
    { time: '2018-11-07', value: 57.21 },
    { time: '2018-11-08', value: 57.21 },
    { time: '2018-11-09', value: 57.65 },
    { time: '2018-11-10', value: 58.27 },
    { time: '2018-11-11', value: 58.46 },
  ...
  return (
    <div className='h-[494px] w-full bg-white'>
      <div id='area-chart' ref={chartRef} className='relative'></div>
    </div>
  );
};
